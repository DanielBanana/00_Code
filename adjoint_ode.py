...
if __name__ == '__main__':
    ...
    solution_and_adjoint_variable_at_t = (integrate.solve_ivp(
    ...
    solution_and_adjoint_variable_at_t = solution_and_adjoint_variable_at_t.reshape((2, 2, time_points_inbetween))
