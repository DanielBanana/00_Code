...
if __name__ == '__main__':
    ...
    parser.add_argument('--script_file', type=str, default='adjoint_master_file_NN.py', help='The script for the design of experiments')
    parser.add_argument('--argument_file', type=str, default='mu5_adam_doe.yaml',
                        help='The yaml file which contains the DoE arguments for the script')
    parser.add_argument('--results_directory_name', type=str, default='mu5_adam_doe',
                        help='The yaml file which contains the DoE arguments for the script')
    ...
    doe_argument_file = os.path.join(directory, args.argument_file)
