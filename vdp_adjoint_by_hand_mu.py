...
def adjoint_model(s, t, args, z_ref, t_span):
    ...
    z_at_current_t_ref = interpolate.interp1d(t_span, z_ref, axis=-1)(t)
    ...
    return np.concatenate((original_rhs, adjoint_rhs), axis=1).flatten()
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        d_J__d_theta__entire_trajectory = (integrate.trapezoid(adjoint_variable_matmul_del_f__del_theta_at_t, t_span, axis=-1) + 
            integrate.trapezoid(d_g__d_mu, t_span[1:], axis = 0)) 
