...
# jacobian(lambda *params: _stateless.functional_call(model, {n: p for n, p in zip(names, params)}, inp), tuple(model.parameters()))
...
class Net(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.nn = Sequential(Linear(in_features=4, out_features=8, bias=True),
                     torch.nn.Tanh(),
